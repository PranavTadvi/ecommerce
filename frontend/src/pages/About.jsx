    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className=" flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>
            ...
            performance, From fashion and beauty to electronics and home
            essentials, we offer an extensive collection source from trusted
            brands and suppliers.
          </p>
          <b className=" text-gray-800">Our Mission</b>
          <p>
            Our mission at Forever customers with choice, and confidance.We're
      ...
      <div className=" flex flex-col md:flex-row text-sm mb-20">
        ...
        <div className=" border px-10 md:px-16 sm:py-20 flex flex-col gap-5">
          <b>Convenience:</b>
          <p className=" text-gray-600">
            With our user-friendly interface and hassel-free ordering process,
            shopping has never been easier.
          </p>
        </div>
        <div className=" border px-10 md:px-16 sm:py-20 flex flex-col gap-5">
          <b>Exceptional Cstomer Service:</b>
          <p className=" text-gray-600">
            Our team of dedicated professionals is here to assit you the way,
            ensuring your satisfation is our top priority.
          </p>
        </div>
      </div>
      <NewsletterBox />
